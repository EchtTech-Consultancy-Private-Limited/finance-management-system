                                            ...
                                            <div class="form-check">
                                                <div class="radio-btn-card d-flex mb-3">
                                                    <div class="d-flex me-5">
                                                        <input class="form-check-radio" type="radio" name="usertype" id="gridRadios1" value="0" checked="">
                                                        <label class="form-label form-check-label" for="gridRadios1">National User</label>
                                                    </div>
                                                    <div class="d-flex">
                                                        <input class="form-check-radio" type="radio" name="usertype" id="gridRadios2" value="1">
                                                        <label class="form-label form-check-label" for="gridRadios2">Institute User</label>
                                                     </div>
                                                </div>
                                                <div class>
                                                ...
                                                <fieldset>
                                                    <input placeholder="Enter Captcha" type="text" name="captcha_code" tabindex="2" id="captcha_code">
                                                    @error('captcha_code')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </fieldset>
