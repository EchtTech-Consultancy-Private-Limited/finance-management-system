...
<div class="row">
           ...
           <div class="col-md-7">
             ...
             <div class="col-md-6">
                <div class="white_card card_height_100 mb_30">
                    ...
                    <div class="white_card_body p-0">
                        <div id="national-total-expenditure-lac-nrcp-lab" class="expenditure_lacks"></div>
            ...
            <div class="col-md-6">
                <div class="white_card card_height_100 mb_30">
                    ...
                    <div class="white_card_body p-0">
                        <div id="national-total-unspent-lac-nrcp-lab" class="expenditure_lacks"></div>
            ...
            <div class="col-md-5">
                <div class="white_card card_height_100 mb_30">
                    ...
                    <div class="white_card_body p-0">
                        ...
                        <div id="integrated-dashboard-chart-overall-program-expenditure-amount-nrcp-lab"></div>
        ...
        <div class="col-md-3">
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="expenditure_height">
                    ...
                    <div id="national_expenditure_percentage_nohppcz_nrcp_lab" class="overall-programm-total"></div>
                </div>
        ...
        <div class="col-md-3">
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="expenditure_height">
                    ...
                    <div id="national_fund_unspent_percentage_nohppcz_nrcp_lab" class="overall-programm-total"></div>
                    </div>
        ...
        <div class="col-md-3">
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="expenditure_height">
                    ...
                    <div id="national_interest_earned_cy_percentage_nohppcz_nrcp_lab" class="overall-programm-total">
                    </div>
                    </div>
        ...
        <div class="col-md-3">
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="expenditure_height">
                    ...
                    <div id="national_dd_percentage_nohppcz_nrcp_lab" class="overall-programm-total">
                    </div>
                    </div>
    ...
    <div class="row ">
        <div class="col-md-3">
            <div class="white_card  ">
                ...
                <div class="white_card">
                    <div id="nohppz_nrcp_lab_chart_currently_UC_Received_nrcp_lab" class=" mb-3 received-chart"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="white_card  ">
                <div class="">
                    <div id="nohppz_nrcp_lab_chart_currently_UC_not_Received_nrcp_lab" class=" mb-3 received-chart"></div>
        ...
        <div class="col-md-3">
            <div class="white_card">
                <div id="nohppz_nrcp_lab_chart_currently_Nos_UC_Received_nrcp_lab" class=" mb-0 received-chart"></div>
        ...
        <div class="col-md-3">
            <div class="white_card  ">
                ...
                <div class="">
                    <div id="nohppz_nrcp_lab_chart_currently_Nos_UC_not_Received_nrcp_lab" class=" mb-0 received-chart"></div>
    ...
    <div class="col-xl-6">
        <div class="white_card mb_30 card_height_100 ">
            ...
            <div class="white_card_body">
                <div id="national_expnediture_nohppcz_nrcp_lab"></div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-6">
        <div class="white_card mb_30 card_height_100 ">
            ...
            <div class="white_card_body">
                <div id="national_instiute_wise_yearly_nohppcz_nrcp_lab"></div>
            </div>
        </div>
    </div>
