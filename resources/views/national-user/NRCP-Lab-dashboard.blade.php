            ...
            <div class="row">
                ...
                <div class="col-md-4 ">
                    <div class="">
                        ...
                        <select id="nrcplab-year" name="financial_year" class="form-control nohppcz_sss_card">
                ...
                <div class="col-md-4 ">
                    <div class="">
                        ...
                        <select name="nrcplab-month" class="form-control nohppcz_sss_card" id="nrcplab-month">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body p-0">
                                <div id="national-nrcplab-total-expenditure-lac" class="expenditure_lacks"></div>
                    ...
                    <div class="col-md-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body p-0">
                                <div id="national-nrcplab-total-unspent-lac" class="expenditure_lacks"></div>
        ...
        <div class="crad white_card mb_30 p-4">
            <div class="row">
                ...
                <div class="">
                    ...
                    <select name="nrcplab-national-ucform-fy" class="form-control nrcplab_national_ucForm_filter" id="nrcplab-national-ucform-fy">
                ...
                <div class="">
                    <label for="" class="text-nowrap me-3 font-16 mb-2"><b>Financial Year </b></label>
                    <select name="nrcplab-national-institute-ucform" class="form-control nrcplab_national_ucForm_filter" id="nrcplab-national-institute-ucform">
        ...
        <div class="white_card mb_30 card_height_100 ">
            <div class="white_card_header">
                <div class="row align-items-center justify-content-between flex-wrap">
                    <div class="col-lg-8">
                        <div class="main-title">
                            <h3 class="m-0">Yearly SOE Expenditure under NRCP-Lab</h3>
                        </div>
                    </div>
                    <div class="col-lg-4 text-end d-flex justify-content-end">
                        <select name="nrcplab-month-soe-expenditure" id="nrcplab-month-soe-expenditure" class="nice_Select2 max-width-220 nohppcz_sssyearly_soe_expenditure">
            ...
            <div class="white_card_body">
                <div id="national_expnediture_nrcplab"></div>
            </div>
        </div>
    </div>
        ...
        <div class="white_card mb_30 card_height_100 ">
            <div class="white_card_header">
                <div class="row align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="col-lg-4 text-end d-flex justify-content-end">
                        <select name="nrcplab-institute-soe-expenditure" id="nrcplab-institute-soe-expenditure" class="nice_Select2 max-width-220 nohppcz_sssyearly_soe_expenditure">
            ...
            <div class="white_card_body">
                <div id="national_instiute_wise_yearly_nrcplab"></div>
            </div>
        </div>
    </div>
    {{-- <div class="devider-line">
    ...
    <div class="col-xl-12 ">
            <div class="crad white_card mb_30 p-4">
                            ...
                            <div class="col-md-12">
                                <div class="float-end mt-4">
                                    <button type="button" class="btn bg-cancel me-3 form_type_uc_list"
                                        id="nrcplab_form_type_uc_list">Search</button>
                ...
                <div class="QA_section">
                    <div class="QA_table form_type_uc_list" id="nrcplab_form_type_uc_list">
                        <table class="table nrcplab_national_uc_filter_datatable table-bordered">
                            <thead>
                                <tr>
