                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body p-0">
                                <div id="national-nohppczsss-total-expenditure-lac" class="expenditure_lacks"></div>
                    ...
                    <div class="col-md-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body p-0">
                                <div id="national-nohppczsss-total-unspent-lac" class="expenditure_lacks"></div>
                ...
                <div class="white_card card_height_100 mb_30">
                    ...
                    <div class="white_card_body p-0 overall-expenditure">
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div id="integrated-dashboard-chart-overall-program-expenditure-amount-sss"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row expenditure_percentage">
            ...
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="white_card_body">
                    ...
                    <div class="expenditure_height">
                        ...
                        <div id="national_expenditure_percentage_nohppcz_sss" class="overall-programm-total"></div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="white_card_body">
                    <div class="expenditure_height">
                        <div id="national_fund_unspent_percentage_nohppcz_sss" class="overall-programm-total"></div>
                    </div>
        ...
        <div class="col-md-4">
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="white_card_body">
                    <div class="expenditure_height">
                        <div id="national_interest_earned_cy_percentage_nohppcz_sss" class="overall-programm-total">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row card-mm">
            <div class="col-md-4 col-lg">
                <div class="single_crm border-line-1 p-0">
                    <div class="crm_body">
                        <h4 id="national-nohppcz-sss-giaReceivedTotal">{{ @$totalArray['giaReceivedTotal'] }}</h4>
            ...
            <div class="col-md-4 col-lg">
                <div class="single_crm border-line-4 p-0">
                    <div class="crm_body">
                        <h4 id="national-nohppcz-sss-actualExpenditureTotal">{{ @$totalArray['actualExpenditureTotal'] }}</h4>
            ...
            <div class="col-md-4 col-lg">
                <div class="single_crm border-line-5 p-0">
                    <div class="crm_body">
                        <h4 id="national-nohppcz-sss-unspentBalance31stTotal">{{ @$totalArray['unspentBalance31stTotal'] }}</h4>
            ...
            <div class="col-md-4 col-lg">
                <div class="single_crm border-line-2 p-0">
                    <div class="crm_body">
                        <h4 id="national-nohppcz-sss-committedLiabilitiesTotal">{{ @$totalArray['committedLiabilitiesTotal'] }}
                        </h4>
            ...
            <div class="white_card_header">
                <div class="row align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="col-lg-4 text-end d-flex justify-content-end">
                        <select name="nohppcz-sss-month-soe-expenditure" id="nohppcz-sss-month-soe-expenditure" class="nice_Select2 max-width-220 nohppcz_sssyearly_soe_expenditure">
        ...
        <div class="white_card mb_30 card_height_100 ">
            <div class="white_card_header">
                <div class="row align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="col-lg-4 text-end d-flex justify-content-end">
                        <select name="nohppcz-sss-institute-soe-expenditure" id="nohppcz-sss-institute-soe-expenditure" class="nice_Select2 max-width-220 nohppcz_sssyearly_soe_expenditure">
        ...
        <div class="col-xl-12 ">
            <div class="crad white_card mb_30 p-4">
                            ...
                            <div class="col-md-12">
                                <div class="float-end mt-4">
                                    <button type="button" class="btn bg-cancel me-3 form_type_uc_list"
                                        id="nohppcz_sss_form_type_uc_list">Search</button>
                ...
                <div class="QA_section">
                    <div class="QA_table form_type_uc_list" id="nohppcz_sss_form_type_uc_list">
                        <table class="table nohppcz_sss_national_uc_filter_datatable table-bordered">
                            <thead>
                                <tr>
