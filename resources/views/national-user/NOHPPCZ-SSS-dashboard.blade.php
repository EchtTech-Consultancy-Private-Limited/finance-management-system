                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body p-0">
                                <div id="national-total-expenditure-lac-sss" class="expenditure_lacks"></div>
                    ...
                    <div class="col-md-6">
                        <div class="white_card card_height_100 mb_30">
                            ...
                            <div class="white_card_body p-0">
                                <div id="national-total-unspent-lac-sss" class="expenditure_lacks"></div>
            ...
            <div class="white_card  mb_30 integrated-expenditure">
                ...
                <div class="white_card_body">
                    <div class="expenditure_height">
                        ...
                        <div id="national_dd_percentage_nohppcz_sss" class="overall-programm-total">
                        </div>
                    </div>
    ...
    <div class="row ">
        <div class="col-md-3">
            <div class="white_card  ">
                ...
                <div class="white_card">
                    <div id="nohppz_rc_chart_currently_UC_Received_sss" class=" mb-3 received-chart"></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="white_card  ">
                <div class="">
                    <div id="nohppz_rc_chart_currently_UC_not_Received_sss" class=" mb-3 received-chart"></div>
        ...
        <div class="col-md-3">
            <div class="white_card">
                <div id="nohppz_rc_chart_currently_Nos_UC_Received_sss" class=" mb-0 received-chart"></div>
        ...
        <div class="col-md-3">
            <div class="white_card  ">
                ...
                <div class="">
                    <div id="nohppz_rc_chart_currently_Nos_UC_not_Received_sss" class=" mb-0 received-chart"></div>
