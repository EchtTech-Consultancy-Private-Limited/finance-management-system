...
Highcharts.chart('nohppz_rc_chart_currently_UC_Received_pm_abhiim', {
 ...
 Highcharts.chart('nohppz_rc_chart_currently_UC_not_Received_pm_abhiim', {
    chart: {
        type: 'pie',
        height: 210,
       //  margin: [0, 0, 0, 0] // Set margins to remove extra space
 ...
 Highcharts.chart('nohppz_rc_chart_currently_Nos_UC_Received_pm_abhiim', {
    chart: {
        type: 'pie',
        height: 210,
       //  margin: [0, 0, 0, 0] // Set margins to remove extra space
 ...
 Highcharts.chart('nohppz_rc_chart_currently_Nos_UC_not_Received_pm_abhiim', {
    chart: {
        type: 'pie',
        height: 210,
       //  margin: [0, 0, 0, 0] // Set margins to remove extra space
...
// ***********************************************************************
  ...
  Highcharts.chart('national_expnediture_nohppcz_pm_abhiim', {
    chart: {
        type: 'column'
    },
    title: {
 ...
 Highcharts.chart('national_instiute_wise_yearly_nohppcz_pm_abhiim', {
    chart: {
        type: 'column'
    },
    title: {
