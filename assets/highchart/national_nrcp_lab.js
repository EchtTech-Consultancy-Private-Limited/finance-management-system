...
Highcharts.chart("national-total-expenditure-lac-nrcp-lab", {
    chart: {
    ...
    Highcharts.chart("national-total-unspent-lac-nrcp-lab", {
    chart: {
        plotBackgroundColor: null,
        height: expenditureHeight,
        margin: [0, 0, 0, 0],
...
overallChart_nrcp_lab.renderer.label('<div style="width: ' + textWidth + 'px; text-align: center; z-index: -1; position:relative;"><span style="font-size:22px; font-weight: 600; margin-bottom:20px;">35,295</span><br><span style="font-size:14px;">All Head <br> Exp.</span></div>', textX, textY, null, null, null, true)
    ...
    Highcharts.chart("national_fund_unspent_percentage_nohppcz_nrcp_lab", {
    chart: {
        plotBackgroundColor: null,
        height: expenditurPercentageeHeight,
        margin: [0, 0, 0, 0],
    ...
    Highcharts.chart("national_interest_earned_cy_percentage_nohppcz_nrcp_lab", {
    chart: {
        plotBackgroundColor: null,
        plotBackgroundColor: null,
        height: expenditurPercentageeHeight,
    ...
    Highcharts.chart("national_dd_percentage_nohppcz_nrcp_lab", {
    chart: {
        plotBackgroundColor: null,
        height: expenditurPercentageeHeight,
        margin: [0, 0, 0, 0],
