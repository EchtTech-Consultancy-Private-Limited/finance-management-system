...
overallChart.renderer.label('<div style="width: ' + textWidth + 'px; text-align: center"><span style="font-size:22px; font-weight: 600; margin-bottom:20px;">32,295</span><br><span style="font-size:14px;">All Program <br> Exp</span></div>', textX, textY, null, null, null, true)
        .css({
            fontSize: '16px',
        }).add();
